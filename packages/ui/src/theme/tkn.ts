...
type ThemePath =
  ...
  | 'colors.table.rowZebra'
  | 'colors.table.rowHover'
  | 'colors.table.rowSelected'
  | 'colors.table.rowSelectedHover'
  | 'colors.table.rowSelectedAccent'
  ...
  | 'colors.landing.onAccent'
  | 'colors.landing.shadowSoft'
  | 'colors.landing.shadowStrong'
  | 'colors.landing.accentBlue'
  | 'colors.landing.accentViolet'
  | 'colors.landing.accentEmerald'
  | 'colors.landing.accentAmber'
  | 'colors.landing.accentRose'
