...
export { EditNoteIcon } from './edit-note';
...
export { FormatListBulletedIcon } from './format-list-bulleted';
...
export const iconMap: Record<string, React.FC<React.SVGProps<SVGSVGElement>>> = {
  ...
  delete: DeleteIcon as any,
  download: DownloadIcon as any,
  dark_mode: MoonIcon as any,
  ...
  'format-list-bulleted': FormatListBulletedIcon as any,
  ...
  keyboard_arrow_down: ExpandMoreIcon as any,
  link: LinkIcon as any,
  list: ViewListIcon as any,
  ...
  settings_suggest: SettingsSuggestIcon as any,
  'shopping-cart': ShoppingCartIcon as any,
  shopping_cart: ShoppingCartIcon as any,
  smartphone: SmartphoneIcon as any,
  store: StoreIcon as any,
  sun: SunIcon as any,
  sync: SyncIcon as any,
