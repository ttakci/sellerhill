...
import { Card, Badge as UIBadge, Text as UIText, tkn, type AppTheme } from '@repo/ui';
...
// --- Compact slider card (horizontal layout: image left, content right) ---
...
export const CompactImage = styled.div`
  width: 8.5rem;
  height: 8.5rem;
  flex-shrink: 0;
  display: flex;
...
export const CompactBadges = styled.div`
  display: flex;
  align-items: center;
  flex-wrap: wrap;
  gap: ${tkn('spacing.sm')};
...
export const CompactAsinRow = styled.div`
  display: flex;
  flex-direction: column;
  gap: ${tkn('spacing.xs')};
`;

export const CompactAsinItem = styled.div`
  display: flex;
  align-items: center;
  gap: ${tkn('spacing.2xs')};
`;
...
export const CompactDetailRow = styled.div`
  display: flex;
  align-items: center;
  gap: ${tkn('spacing.2xs')};
  min-width: 0;
...
export const CompactExtraFields = styled.div`
  display: flex;
  align-items: center;
  flex-wrap: wrap;
  gap: ${tkn('spacing.sm+')};
...
export const CompactFieldItem = styled.div`
  display: flex;
  align-items: center;
  gap: ${tkn('spacing.xs')};
...
export const CompactFieldValue = styled.span`
  font-size: ${tkn('typography.fontSize.xs')};
  font-weight: ${tkn('typography.fontWeight.medium')};
  color: ${tkn('colors.text.secondary')};
  white-space: nowrap;
...
export const CompactProfitRow = styled.div`
...
export const CompactProfitItem = styled.div`
  display: flex;
  flex-direction: column;
  gap: ${tkn('spacing.2xs')};
  flex: 1;
...
export const CompactProfitValue = styled.span<{ $positive?: boolean; $negative?: boolean }>`
  font-size: ${tkn('typography.fontSize.sm')};
