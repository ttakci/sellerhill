...
describe('AssistantContextRouterService', () => {
  ...
  it('routes deterministic detail intent', () => {
    const plan = router.plan('show listing 123e4567-e89b-42d3-a456-426614174000');
    expect(plan.tools).toEqual([{ name: AssistantToolName.LISTING_DETAIL, resourceId: '123e4567-e89b-42d3-a456-426614174000' }]);
  });
  it('never routes destructive requests', () => {
    const plan = router.plan('delete order 123e4567-e89b-42d3-a456-426614174000');
